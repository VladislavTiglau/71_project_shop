...
public class Client {
    ...
    public static void prductOperations() {
        while (true) {
            try {
                ...
                System.out.println("10 - получить среднюю стоймость продуктов");
                System.out.println("0 - выход");
    ...
    public static void customerOperations() {
        while (true) {
            try {
                ...
                System.out.println("9 - получить стоймость корзины покупателя");
                System.out.println("10 - получить среднюю стоймость продукта в корзине покупателя");
                ...
                switch (input) {
                    ...
                    case "4":
                        System.out.println("Введите идентификатор");
                        id = Integer.parseInt(scanner.nextLine());
                        System.out.println("Ведите новое имя покупателя");
                    ...
                    case "9":
                        System.out.println("Введите идентификатор");
                        id = Integer.parseInt(scanner.nextLine());
                        System.out.println("Стоймость корзины покупателя: " +
